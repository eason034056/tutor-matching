    ...
    <header className="bg-[#233B6E] text-primary-foreground p-4">
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <nav className={`${isMenuOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`}>
          <ul className="flex flex-col md:flex-row px-4 md:px-0 md:space-x-4 space-y-4 md:space-y-0 mt-4 md:mt-0">
            <li><Link href="/" className="hover:underline block text-right md:text-left">首頁</Link></li>
            <li><Link href="/tutors" className="hover:underline block text-right md:text-left">尋找家教</Link></li>
            <li><Link href="/tutor-cases" className="hover:underline block text-right md:text-left">家教案件</Link></li>
            <li><Link href="/case-upload" className="hover:underline block text-right md:text-left">刊登需求</Link></li>
